...
def run_circle_sequence():
    ...
    # 2. Fly in a circle
    # The duration determines the size of the circle.
    print("Step 2: Flying in a circle for 6.5 seconds...");
    command_queue.put(PACKET_CIRCLE)
    time.sleep(6.5) # FIX: Changed duration from 8.0 to 6.5 seconds
    command_queue.put(PACKET_STOP)
    time.sleep(1.0)
