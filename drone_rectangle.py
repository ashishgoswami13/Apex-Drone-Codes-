...
# --- NEW: Automated Rectangle Sequence ---
def run_rectangle_sequence():
    ...
    # 2. Fly Forward (Long side)
    print("Step 2: Flying forward for 2.0 seconds...")
    command_queue.put(PACKET_FORWARD)
    time.sleep(2.0) # <-- You can change this value
    command_queue.put(PACKET_STOP)
    time.sleep(1.0)
    
    # 3. Fly Right (Short side)
    print("Step 3: Flying right for 1.5 seconds...")
    command_queue.put(PACKET_RIGHT)
    time.sleep(1.5) # <-- You can change this value
    command_queue.put(PACKET_STOP)
    time.sleep(1.0)

    # 4. Fly Backward (Long side)
    print("Step 4: Flying backward for 2.0 seconds...")
    command_queue.put(PACKET_BACKWARD)
    time.sleep(2.0) # <-- Should match Step 2
    command_queue.put(PACKET_STOP)
    time.sleep(1.0)

    # 5. Fly Left (Short side)
    print("Step 5: Flying left for 1.5 seconds...")
    command_queue.put(PACKET_LEFT)
    time.sleep(1.5) # <-- Should match Step 3
    command_queue.put(PACKET_STOP)
    time.sleep(1.0)
    ...
    if connect():
        ...
        try:
            while is_running.is_set():
                ...
                print(f"{'r. Run Rectangle Sequence':<25} |")
                print("-" * 60)
